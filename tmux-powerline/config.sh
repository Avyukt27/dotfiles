...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/getplayed/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/getplayed"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/getplayed/.mailcheckrc"
# }
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/getplayed/.now_playing.log"
...
export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/getplayed/.tmux/plugins/tmux-continuum"
# }
